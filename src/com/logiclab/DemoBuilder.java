 ...
 * and serializes it to demo_circuit.llb in the project root.
 *
 * Run with: ./gradlew run -PmainClass=com.logiclab.DemoBuilder
...
public class DemoBuilder {
    public static void main(String[] args) throws Exception {
        ...
        File out = new File("demo_circuit.llb");
