...
import com.logiclab.io.dto.SubCircuitDTO;
import com.logiclab.model.subcircuit.SubCircuitDefinition;

import java.io.File;
import java.io.IOException;

/** Reads/writes .lls sub-circuit definition files. */
public final class SubCircuitIO {
    ...
    public static SubCircuitDefinition read(File file) throws IOException {
        ...
        if (dto.circuit() == null) throw new IOException("Malformed .lls file: missing circuit");
