 ...
 * {@code ~/.logiclab/subcircuits/<id>.lls}.
 *
...
public final class SubCircuitLibrary {
    ...
    public static File directory() {
        File dir = new File(System.getProperty("user.home"), ".logiclab/subcircuits");
    ...
    public static File fileFor(String id) {
        return new File(directory(), sanitize(id) + ".lls");
    }
    ...
    public static synchronized void reload() {
        ...
        scanned = true;
        File dir = directory();
        File[] files = dir.listFiles((d, name) -> name.toLowerCase().endsWith(".lls"));
