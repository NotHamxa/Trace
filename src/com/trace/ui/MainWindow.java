...
public class MainWindow {
    ...
    private boolean saveSubCircuit() {
        boolean hasPort = circuit.getComponents().stream().anyMatch(c ->
                ...
                c instanceof com.trace.model.ports.OutputPort);
        if (!hasPort) {
        ...
        for (com.trace.model.Component comp : circuit.getComponents()) {
            String label = null;
            String fallback = null;
            if (comp instanceof com.trace.model.ports.InputPort ip) {
                label = ip.getPortLabel();
                fallback = "IN";
            } else if (comp instanceof com.trace.model.ports.OutputPort op) {
        ...
        try {
            com.trace.model.subcircuit.SubCircuitDefinition def =
                    new com.trace.model.subcircuit.SubCircuitDefinition(subCircuitId, subCircuitName, circuit);
            com.trace.io.SubCircuitLibrary.save(def, System.getProperty("user.name"));
