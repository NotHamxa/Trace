...
import com.trace.util.DemoLibrary;
import com.trace.util.DemoLibrary.Demo;
...
public class StartMenu {
        ...
        return new ListCell<File>() {
            ...
            protected void updateItem(File f, boolean empty) {
                ...
                if (empty || f == null) {
                    ...
                    if (fname.endsWith(".trc")) fname = fname.substring(0, fname.length() - 4);
                    name.setText(fname);
    ...
    private void exportSubcircuit(SubCircuitDefinition def) {
        ...
        chooser.getExtensionFilters().add(
                new FileChooser.ExtensionFilter("Trace Sub-Circuit", "*.trs"));
        chooser.setInitialFileName(def.getId() + ".trs");
